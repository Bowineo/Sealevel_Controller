...
namespace CHOV
{
    public partial class FrmConfiguracoes : Form
    {
        ...
        {
            CmpTIN01.Text = Functions.String7chars(CmpTIN01.Text);
            CmpTIN02.Text = Functions.String7chars(CmpTIN02.Text);
            CmpTIN03.Text = Functions.String7chars(CmpTIN03.Text);
            CmpTIN04.Text = Functions.String7chars(CmpTIN04.Text);
            CmpTIN05.Text = Functions.String7chars(CmpTIN05.Text);
            CmpTIN06.Text = Functions.String7chars(CmpTIN06.Text);
            CmpTIN07.Text = Functions.String7chars(CmpTIN07.Text);
            CmpTIN08.Text = Functions.String7chars(CmpTIN08.Text);
            CmpTIN09.Text = Functions.String7chars(CmpTIN09.Text);
            CmpTIN010.Text = Functions.String7chars(CmpTIN010.Text);
            CmpTIN011.Text = Functions.String7chars(CmpTIN011.Text);
            CmpTIN012.Text = Functions.String7chars(CmpTIN012.Text);
            CmpTIN013.Text = Functions.String7chars(CmpTIN013.Text);
            CmpTIN014.Text = Functions.String7chars(CmpTIN014.Text);
            CmpTIN015.Text = Functions.String7chars(CmpTIN015.Text);
            CmpTIN016.Text = Functions.String7chars(CmpTIN016.Text);
            CmpRIN1.Text = Functions.String7chars(CmpRIN1.Text);
            CmpRIN2.Text = Functions.String7chars(CmpRIN2.Text);
            CmpRIN3.Text = Functions.String7chars(CmpRIN3.Text);
            CmpRIN4.Text = Functions.String7chars(CmpRIN4.Text);
            CmpRIN5.Text = Functions.String7chars(CmpRIN5.Text);
            CmpRIN6.Text = Functions.String7chars(CmpRIN6.Text);
            CmpRIN7.Text = Functions.String7chars(CmpRIN7.Text);
            CmpRIN8.Text = Functions.String7chars(CmpRIN8.Text);
            CmpRIN9.Text = Functions.String7chars(CmpRIN9.Text);
            CmpRIN10.Text = Functions.String7chars(CmpRIN10.Text);
            CmpRIN11.Text = Functions.String7chars(CmpRIN11.Text);
            CmpRIN12.Text = Functions.String7chars(CmpRIN12.Text);
            CmpRIN13.Text = Functions.String7chars(CmpRIN13.Text);
            CmpRIN14.Text = Functions.String7chars(CmpRIN14.Text);
            CmpRIN15.Text = Functions.String7chars(CmpRIN15.Text);
            CmpRIN16.Text = Functions.String7chars(CmpRIN16.Text);
            CmpOut1.Text = Functions.String7chars(CmpOut1.Text);
            CmpOut2.Text = Functions.String7chars(CmpOut2.Text);
            CmpOut3.Text = Functions.String7chars(CmpOut3.Text);
            CmpOut4.Text = Functions.String7chars(CmpOut4.Text);
            CmpOut5.Text = Functions.String7chars(CmpOut5.Text);
            CmpOut6.Text = Functions.String7chars(CmpOut6.Text);
            CmpOut7.Text = Functions.String7chars(CmpOut7.Text);
            CmpOut8.Text = Functions.String7chars(CmpOut8.Text);
            CmpOut9.Text = Functions.String7chars(CmpOut9.Text);
            CmpOut10.Text = Functions.String7chars(CmpOut10.Text);
            CmpOut11.Text = Functions.String7chars(CmpOut11.Text);
            CmpOut12.Text = Functions.String7chars(CmpOut12.Text);
            CmpOut13.Text = Functions.String7chars(CmpOut13.Text);
            CmpOut14.Text = Functions.String7chars(CmpOut14.Text);
            CmpOut15.Text = Functions.String7chars(CmpOut15.Text);
            CmpOut16.Text = Functions.String7chars(CmpOut16.Text);
        }
                    ...
                    if (resultado3 == DialogResult.OK)
                    {
                        ...
                        switch (Properties.Settings.Default.System)
                        {
                            case "Change Over":
                                ...
                                {
                                    string str = Functions.IdentificaTrueFalse(Somente1Chg0Vetor(frmC.ArrayInputPrimary), Somente1Chg0Vetor(frmC.ArrayInputSecondary), Somente1Chg0Vetor(frmC.ArrayOutput));
        ...
        public int WritevarSetting(string[] entrada)
        {
            ...
            else
            {
                ...
                Ch_EnableLog.Checked = Functions.TrueFalse(entrada[9]);
                Tbpathselect.Text = entrada[10];
                Cb_MaxSizeLog.Text = entrada[11];
                ch_Showcombinacoes.Checked = Functions.TrueFalse(entrada[12]);

                Ch_Username.Checked = Functions.TrueFalse(entrada[13]);
                Ch_Level.Checked = Functions.TrueFalse(entrada[14]);
                Ch_Method.Checked = Functions.TrueFalse(entrada[15]);
                Ch_Message.Checked = Functions.TrueFalse(entrada[16]);
                Ch_Thread.Checked = Functions.TrueFalse(entrada[17]);
                Ch_Line.Checked = Functions.TrueFalse(entrada[18]);
                Ch_identity.Checked = Functions.TrueFalse(entrada[19]);
                Ch_Location.Checked = Functions.TrueFalse(entrada[20]);
        ...
        public void AlimenteLIST()
        {
            ...
            for (int i = 0; i < cont; i++)
            {
                ...
                { dGv.Rows.Add(Functions.Dvet(combi)); }
            }
        }
        ...
        public string[] GetDgv(int entrada)
        {
            ...
            for (int i = 0; i < l; i++)
            {
                ...
                sasuke[i] = Functions.Cvet(k[0], p1, k[2], k[3], k[4], p2, k[6], k[7], k[8]);
            }
            return sasuke;
        }
        ...
        private void CmBposicao1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                LblPosicao1.Text = SystemSoftware.PosicaoIndexNEW(Properties.Settings.Default.NamesInputPrimary, cmBposicao1.Text);
                frmC.indxCmbP1 = Functions.QualIN(cmBposicao1.SelectedIndex.ToString());
                if (cmbOperamtx.Text != "")
                {
                    cmbSaida.Text = "";
                    LblOutput.Text = "";
            ...
            {
                LblPosicao1.Text = SystemSoftware.PosicaoIndexNEW(Properties.Settings.Default.NamesInputSecondary, cmBposicao1.Text);
                frmC.indxCmbP1 = Functions.QualIN(cmBposicao1.SelectedIndex.ToString());
                if (cmbOperamtx.Text != "")
                {
                    cmbSaida.Text = "";
        ...
        private void CmBposicao2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                LblPosicao2.Text = SystemSoftware.PosicaoIndexNEW(Properties.Settings.Default.NamesInputPrimary, cmBposicao2.Text);
                frmC.indxCmbP2 = Functions.QualIN(cmBposicao2.SelectedIndex.ToString());
                if (cmbOperamtx.Text != "")
                {
                    cmbSaida.Text = "";
                    LblOutput.Text = "";
            ...
            {
                LblPosicao2.Text = SystemSoftware.PosicaoIndexNEW(Properties.Settings.Default.NamesInputSecondary, cmBposicao2.Text);
                frmC.indxCmbP2 = Functions.QualIN(cmBposicao2.SelectedIndex.ToString());
                if (cmbOperamtx.Text != "")
                {
                    cmbSaida.Text = "";
        ...
        {
            VisibleBotoes(true, false, false, false, false);
            if (cmbSaida.Text != "") { LblOutput.Text = SystemSoftware.PosicaoIndexOut(Properties.Settings.Default.NamesOutput, cmbSaida.Text); }
            frmC.indxCmbOut = Functions.QualOUT(cmbSaida.SelectedIndex.ToString());
        ...
        public string[] GetDgV()
        {
            ...
            if (dGv.Rows[k].Cells[0].Value != null && k >= 0 && (dGv.Rows[k].Cells[0].Value.ToString() != ""))
            {
                ...
                V = Functions.Dvet(Functions.Cvet(dGv.Rows[k].Cells[0].Value.ToString(), k1, dGv.Rows[k].Cells[2].Value.ToString(), dGv.Rows[k].Cells[3].Value.ToString(), dGv.Rows[k].Cells[4].Value.ToString(), k2, dGv.Rows[k].Cells[6].Value.ToString(), dGv.Rows[k].Cells[7].Value.ToString(), dGv.Rows[k].Cells[8].Value.ToString()));
            ...
            if (dGv.Rows[k].Cells[0].Value != null)
            {
                if (k >= 0)
                {
                    if ((dGv.Rows[k].Cells[0].Value.ToString() != ""))
                    {
                        ...
                        string[] V = Functions.Dvet(Functions.Cvet(dGv.Rows[k].Cells[0].Value.ToString(), p1, dGv.Rows[k].Cells[2].Value.ToString(), dGv.Rows[k].Cells[3].Value.ToString(), dGv.Rows[k].Cells[4].Value.ToString(), p2, dGv.Rows[k].Cells[6].Value.ToString(), dGv.Rows[k].Cells[7].Value.ToString(), dGv.Rows[k].Cells[8].Value.ToString()));
                        if (V[1].Length > 5) { V[1] = V[1]; }
                        else { V[1] = "    " + V[1]; }
                        if (V[5].Length > 5) { V[5] = V[5]; }
                        else { V[5] = "    " + V[5]; }
        ...
        public string[] ReplaceNamesCombinations()
        {
            ...
            for (int i = 0; i < Combinados.Count; i++)
            {
                ...
                {
                    string[] k = Functions.Dvet(Combinados[i]);
                    dev1 = k[0];
                    pos1 = k[1];
                    ind1 = Math.Abs(SystemSoftware.ZeroNegativo(Functions.TToNintINnot(k[1])));
                    _ = k[2];
                    dev2 = k[4];
                    pos2 = k[5];
                    ind2 = Math.Abs(SystemSoftware.ZeroNegativo(Functions.TToNintINnot(k[5])));
                    _ = k[6];
                    operacao = k[3];
                    saida = k[7];
                    namesaida = NamesOutput[Functions.ToNintOUT(k[7])];
                    switch (dev1)
                    {
                    ...
                    Combinados[i] = Functions.Cvet(dev1, Po1, name1, operacao, dev2, Po2, name2, saida, namesaida);
                }
                else { Combinados[i] = ""; }
            }
        ...
        {
            string dados = Functions.Cvet(cmBdeviceposicao1.Text, cmBposicao1.Text, LblPosicao1.Text, cmbOperamtx.Text, cmBdeviceposicao2.Text, cmBposicao2.Text, LblPosicao2.Text, cmbSaida.Text, LblOutput.Text);
            if (dados.Length == 100)
            {
                string[] ds = Functions.Dvet(dados);
                dGv.Rows.Add(ds);
            }
            else
            {
        ...
        void MensagemAdequadaChangeOver(string str)
        {
            ...
            {
                case "VFF":
                    using (Form MsgBox = new MmsgBox("Secondary: " + MensagemErroSomemte1Chg0(Functions.DiscretagemInt(Somente1Chg0Vetor2ret(frmC.ArrayInputSecondary))) + Environment.NewLine + "Output: " + MensagemErroSomemte1Chg0(Functions.DiscretagemInt(Somente1Chg0Vetor2ret(frmC.ArrayOutput))), "OK", 3, 0))
                    { _ = MsgBox.ShowDialog(); AtualizaSettingsnoSistem(); return; }
                case "FVF":
                    using (Form MsgBox1 = new MmsgBox("Primary: " + MensagemErroSomemte1Chg0(Functions.DiscretagemInt(Somente1Chg0Vetor2ret(frmC.ArrayInputPrimary))) + Environment.NewLine + "Output: " + MensagemErroSomemte1Chg0(Functions.DiscretagemInt(Somente1Chg0Vetor2ret(frmC.ArrayOutput))), "OK", 3, 0))
                    { _ = MsgBox1.ShowDialog(); AtualizaSettingsnoSistem(); return; }
                case "VVF":
                    using (Form MsgBox2 = new MmsgBox("Output: " + MensagemErroSomemte1Chg0(Functions.DiscretagemInt(Somente1Chg0Vetor2ret(frmC.ArrayOutput))), "OK", 3, 0))
                    { _ = MsgBox2.ShowDialog(); AtualizaSettingsnoSistem(); return; }
                case "FFF":
                    using (Form MsgBox3 = new MmsgBox("Primary: " + MensagemErroSomemte1Chg0(Functions.DiscretagemInt(Somente1Chg0Vetor2ret(frmC.ArrayInputPrimary))) + Environment.NewLine + "Secondary: " + MensagemErroSomemte1Chg0(Functions.DiscretagemInt(Somente1Chg0Vetor2ret(frmC.ArrayInputSecondary))) + Environment.NewLine + "Output: " + MensagemErroSomemte1Chg0(Functions.DiscretagemInt(Somente1Chg0Vetor2ret(frmC.ArrayOutput))), "OK", 3, 0))
                    { _ = MsgBox3.ShowDialog(); AtualizaSettingsnoSistem(); return; }
                case "FFV":
                    using (Form MsgBox4 = new MmsgBox("Primary: " + MensagemErroSomemte1Chg0(Functions.DiscretagemInt(Somente1Chg0Vetor2ret(frmC.ArrayInputPrimary))) + Environment.NewLine + "Secondary: " + MensagemErroSomemte1Chg0(Functions.DiscretagemInt(Somente1Chg0Vetor2ret(frmC.ArrayInputSecondary))), "OK", 3, 0))
                    { _ = MsgBox4.ShowDialog(); AtualizaSettingsnoSistem(); return; }
                case "FVV":
                    using (Form MsgBox5 = new MmsgBox("Primary: " + MensagemErroSomemte1Chg0(Functions.DiscretagemInt(Somente1Chg0Vetor2ret(frmC.ArrayInputPrimary))), "OK", 3, 0))
                    { _ = MsgBox5.ShowDialog(); AtualizaSettingsnoSistem(); return; }
                case "VFV":
                    using (Form MsgBox6 = new MmsgBox("Secondary: " + MensagemErroSomemte1Chg0(Functions.DiscretagemInt(Somente1Chg0Vetor2ret(frmC.ArrayInputSecondary))), "OK", 3, 0))
